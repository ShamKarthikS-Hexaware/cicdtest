...
using ElmahCore.Mvc;
using ElmahCore;
using dotnettestcd.Api.Filters;
using dotnettestcd.Business.Installer;

namespace dotnettestcd.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "dotnettestcd API", Version = version + "-" + branch});
            });
